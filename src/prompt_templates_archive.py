...
OVERALL_SUMMARY_TEMPLATE = """
    You are a science writer summarizing recent developments in {subject_area}. Use the summaries below to write a clear, engaging, and structured overview.

    1. **Group the summaries into themes** based on common topics, questions, or areas of research.
    2. For each theme:
       - Briefly describe the shared topic or problem.
       - Summarize the key contributions of relevant summaries.
       - Include timing and relevance where applicable.
    3. **After the summary**, output a clearly marked section listing the most notable individual sources.
